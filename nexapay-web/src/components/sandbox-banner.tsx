...
export function SandboxBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center gap-2 bg-amber-500/10 border-b border-amber-500/20 px-4 py-2 text-[12px] font-medium text-amber-400 backdrop-blur-sm">
