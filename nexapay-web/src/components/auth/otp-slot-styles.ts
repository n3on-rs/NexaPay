...
export const otpSlotCircle = (invalid?: boolean) =>
  cn(
    ...
    "dark:bg-[#0a0b0e]",
    "dark:data-[active=true]:z-10 dark:data-[active=true]:border-[#00d4aa] dark:data-[active=true]:ring-2 dark:data-[active=true]:ring-[#00d4aa]/30",
    invalid &&
...
export const pinSlotCircle = (invalid?: boolean) =>
  cn(
    ...
    "dark:data-[active=true]:border-[#00d4aa] dark:data-[active=true]:ring-2 dark:data-[active=true]:ring-[#00d4aa]/30",
    invalid &&
      "border-red-500 ring-2 ring-red-500/25 dark:data-[active=true]:border-red-500",
  );
